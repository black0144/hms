...
function checkbook()
{
if((discount_add.level.value!="")&&(discount_add.percent.value!==""))
return true;
else{
alert("请填完所有项目！");
return false;
...
<form action="discount_add.php" method="post" name="discount_add" onSubmit="return checkbook()">
<p>客人等级：<input type="text" name="level"> </p>
<p>折扣比例：<input type="text" name="percent"></p>
