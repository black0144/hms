...
//查询预订房间订单，只取出一页的数据
$sqlpage="select * from book order by bookintime limit ".($page-1)*$page_size.",$page_size;";
...
echo "<td>"
?>
<input type="button" name="edit" value="修改" onclick="location.href='book_edit_input.php?bookid=<?php echo $row[bookid]?>'">
<input type="button" name="delete" value="删除" onClick="if(confirm('确定要删除此预订？')) location.href='book_del.php?bookid=<?php echo $row[bookid]?>'">
</td></tr>
<?php
}
echo "</table>";
